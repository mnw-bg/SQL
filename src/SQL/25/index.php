...
if (!empty($autot)) {
    echo "<table border='1'>";
     ...
     echo "<tr><th>ID</th><th>Nimi</th><th>Hinta</th><th>Kuvaus</th><th>Katekoria</th><th>Toiminnot</th></tr>";
    ...
    foreach ($autot as $auto) {
        ...
        echo "<td>" . htmlspecialchars($auto['Nimi']) . "</td>";
        echo "<td>" . htmlspecialchars($auto['Hinta']) . "</td>";
        echo "<td>" . htmlspecialchars($auto['Kuvaus']) . "</td>";
        echo "<td>" . htmlspecialchars($auto['katekoria']) . "</td>";
        echo "<td>";
